...
tamanhao_pg_ajax = 'tamanhoPagina=15&'
...
data_ajax = {'paginacaoSimples':'true','tamanhoPagina':'15', 'offset':'0','direcaoOrdenacao':'desc', \
...
data = dict_convenio['data']
colunas = dict(data[0])

nm_columns = ''
nome_arquivo = 'teste_grav.csv'
...
with open(nome_arquivo, 'w') as f:
    ...
    for value in data:
        ...
        if tb_detalhes['data']:
            ...
            # valores = 0
            valor_total = 0
            #data_pgto_detalhe = data_detalhe
        # ------------ FIM DOS DETALHES DE CADA CONVENIO -------------------

        #import pdb; pdb.set_trace()
        # value['data_detalhe'] = data_detalhe
        # value['valores'] = valores
        #valores = str(valores)
        ...
        #exit()
        # if len(data_pgto_detalhe) > 1:
        #     writer = csv.DictWriter(open(nome_arquivo, 'a' ), data_pgto_detalhe)
...
# import pdb; pdb.set_trace()
# print("PRINTAR br_colunas - FIM")
#
#
# js = json.dumps(dict_convenio, sort_keys=True, indent=4, separators=(',', ': '))
# #with open('test.json', 'w+', encoding='utf8') as f:
# with open('test.json', 'w+', encoding='utf8') as f:
#     f.write(js)
# with open('convenio.html', 'w') as f:
#     write(f)
